...
export default function App() {
  ...
  const { tab, setTab, selectedGroup, setSelectedGroup, matches, loading, error, retry, liveCount: effectiveLiveCount, resultsMap, hasMarket } = state;
    ...
    <>
      ...
      <div className={styles.root}>
        ...
        <header className={styles.header}>
          ...
          {/* Settings-Button (with live badge) */}
          <div className={styles.iconBtnWrap}>
            ...
            {effectiveLiveCount > 0 && !showSettings && (
              <span className={styles.liveBadge} aria-label={`${effectiveLiveCount} Spiel${effectiveLiveCount > 1 ? 'e' : ''} live`} />
            )}
          </div>
        </header>
