...
export const NATION_STATS: Record<string, TeamStats> = {
  ...
  GER: { rank:  8, hGF: 2.04, hGA: 1.45, aGF: 2.04, aGA: 1.45 },
  URU: { rank:  9, hGF: 1.01, hGA: 0.99, aGF: 1.01, aGA: 0.99 },
  COL: { rank: 10, hGF: 1.87, hGA: 1.08, aGF: 1.87, aGA: 1.08 },
  BEL: { rank: 11, hGF: 2.28, hGA: 1.00, aGF: 2.28, aGA: 1.00 },
  USA: { rank: 12, hGF: 1.52, hGA: 1.54, aGF: 1.52, aGA: 1.54 },
  ...
  SEN: { rank: 17, hGF: 1.35, hGA: 1.59, aGF: 1.35, aGA: 1.59 },
  CRO: { rank: 18, hGF: 1.37, hGA: 1.30, aGF: 1.37, aGA: 1.30 },
  SUI: { rank: 19, hGF: 1.88, hGA: 1.26, aGF: 1.88, aGA: 1.26 },
  AUT: { rank: 20, hGF: 1.83, hGA: 0.99, aGF: 1.83, aGA: 0.99 },
  DEN: { rank: 21, hGF: 1.22, hGA: 1.22, aGF: 1.22, aGA: 1.22 },
  UKR: { rank: 22, hGF: 1.15, hGA: 1.93, aGF: 1.15, aGA: 1.93 },
  IRN: { rank: 23, hGF: 0.90, hGA: 1.05, aGF: 0.90, aGA: 1.05 },
  AUS: { rank: 24, hGF: 1.25, hGA: 0.96, aGF: 1.25, aGA: 0.96 },
  SRB: { rank: 25, hGF: 0.83, hGA: 2.02, aGF: 0.83, aGA: 2.02 },
  TUR: { rank: 26, hGF: 1.35, hGA: 2.16, aGF: 1.35, aGA: 2.16 },
  KOR: { rank: 27, hGF: 1.23, hGA: 1.46, aGF: 1.23, aGA: 1.46 },
  POL: { rank: 28, hGF: 1.27, hGA: 1.85, aGF: 1.27, aGA: 1.85 },
  ECU: { rank: 29, hGF: 0.94, hGA: 0.65, aGF: 0.94, aGA: 0.65 },
  SCO: { rank: 30, hGF: 1.40, hGA: 1.45, aGF: 1.40, aGA: 1.45 },
  SVN: { rank: 31, hGF: 0.89, hGA: 1.43, aGF: 0.89, aGA: 1.43 },
  CIV: { rank: 32, hGF: 1.38, hGA: 0.89, aGF: 1.38, aGA: 0.89 },
  SAU: { rank: 33, hGF: 0.62, hGA: 1.28, aGF: 0.62, aGA: 1.28 },
  NGA: { rank: 34, hGF: 1.60, hGA: 1.02, aGF: 1.60, aGA: 1.02 },
  ...
  GHA: { rank: 38, hGF: 0.60, hGA: 2.31, aGF: 0.60, aGA: 2.31 },
  TUN: { rank: 39, hGF: 0.98, hGA: 1.42, aGF: 0.98, aGA: 1.42 },
  VEN: { rank: 40, hGF: 0.81, hGA: 1.54, aGF: 0.81, aGA: 1.54 },
  PAN: { rank: 41, hGF: 1.19, hGA: 1.81, aGF: 1.19, aGA: 1.81 },
  IRQ: { rank: 42, hGF: 0.56, hGA: 1.24, aGF: 0.56, aGA: 1.24 },
  QAT: { rank: 43, hGF: 0.97, hGA: 1.92, aGF: 0.97, aGA: 1.92 },
  RSA: { rank: 44, hGF: 0.90, hGA: 1.05, aGF: 0.90, aGA: 1.05 },
  JAM: { rank: 45, hGF: 0.64, hGA: 1.78, aGF: 0.64, aGA: 1.78 },
  JOR: { rank: 46, hGF: 1.16, hGA: 1.77, aGF: 1.16, aGA: 1.77 },
  HON: { rank: 47, hGF: 0.77, hGA: 1.58, aGF: 0.77, aGA: 1.58 },
  NZL: { rank: 48, hGF: 0.43, hGA: 1.78, aGF: 0.43, aGA: 1.78 },
  CZE: { rank: 28, hGF: 1.23, hGA: 1.73, aGF: 1.23, aGA: 1.73 },
  BIH: { rank: 36, hGF: 0.86, hGA: 2.25, aGF: 0.86, aGA: 2.25 },
  SWE: { rank: 25, hGF: 1.66, hGA: 2.19, aGF: 1.66, aGA: 2.19 },
  NOR: { rank: 27, hGF: 1.52, hGA: 1.32, aGF: 1.52, aGA: 1.32 },
  ALG: { rank: 35, hGF: 1.32, hGA: 0.80, aGF: 1.32, aGA: 0.80 },
  CPV: { rank: 46, hGF: 1.15, hGA: 0.98, aGF: 1.15, aGA: 0.98 },
  COD: { rank: 40, hGF: 0.75, hGA: 0.80, aGF: 0.75, aGA: 0.80 },
  UZB: { rank: 44, hGF: 0.90, hGA: 1.11, aGF: 0.90, aGA: 1.11 },
  HAI: { rank: 48, hGF: 1.13, hGA: 1.58, aGF: 1.13, aGA: 1.58 },
  CUW: { rank: 47, hGF: 1.31, hGA: 2.27, aGF: 1.31, aGA: 2.27 },
};
